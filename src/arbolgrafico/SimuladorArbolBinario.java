...
public class SimuladorArbolBinario {
    ...
    public boolean insertar(Integer dato,String mensaje) {
        return (this.miArbol.agregar(dato,mensaje));
    }
    ...
    public String esta(Integer dato) {
        ...
        r += siEsta ? "Si se encuentra en el arbol"+ "\n"+ "La denucia es "+"\n"+this.miArbol.buscarNodo(dato).getMensaje() : "No se encuentra en el arbol";
        return (r);
    }
